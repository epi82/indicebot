...
if ($gen!="" AND $spe!="")
    {
    $query = "SELECT * FROM genspe WHERE genere='$gen' AND specie='$spe'";
...
<script type="text/javascript" src="../js/FormEditGenSpe.js"></script>
<script type="text/javascript" src="../js/FormEditGenSpe_Step2.js"></script>
...
<table class="Table_Corpo_Admin" cellpadding="10" height="351" width="980">
 ...
 ?> 
     <tr class="testo1">
         ...
         <br />  
            <div align="center">
                <div id="formEditGenSpe_Step2"></div>                
            </div>
        </td>
     </tr>
 <?
